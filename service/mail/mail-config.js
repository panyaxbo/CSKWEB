...
config.CLIENT_ID = '399163375101-n7nofhro2cegvklei2bedigo4usg8tk1.apps.googleusercontent.com';
config.CLIENT_SECRET = 'BK3OMcWn6ZTL3Rt6RshOXhEp';
config.CLIENT_REFRESH_TOKEN = '1/9qw6GxIOZaPsYI5I2Bamqgy_FWYO_bAzoH1pszw0JzM';
config.CLIENT_ACCESS_TOKEN = 'ya29.qgItRIaNVxPICnIE7vT8vW7ijFQGwienajmRB4q3hGmGkwgHUB0Lu3MZq8dsfvKUsQ';

config.MAIL_CONTENT_TITLE = '<meta charset="utf-8" http-equiv="imagetoolbar" content="no">'+
                     ...
                     '   <tr><td align="left" valign="middle">' +
                            ...
                            '<table width="115" border="0" cellspacing="0" cellpadding="0" >' +
                                '<tr><td align="left" valign="top" class="mob_center">' +
                                    ...
                                    '<img src="cid:CSK_icon_black@caramel.srikho.com" width="100" height="100" alt="Metronic" border="0" style="display: block;" /></font></a>' +
                                '</td></tr>' +
                            '</table>  ' +                      
                        '</td></tr>' +
                    '</table></div>' +
...
config.MAIL_CONTENT_FOOTER = '<tr><td align="center" bgcolor="#ffffff" style="border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #eff2f4;">'+
        ...
        '<table width="100%" border="0" cellspacing="0" cellpadding="0">'+
            '<tr><td align="center">'+
                ...
                '<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">'+
                    '2016 © Caramel Srikho. ALL Rights Reserved.'+
                '</span></font>'+              
            '</td></tr>'+          
        '</table>'+
