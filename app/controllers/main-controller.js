"use strict"
app.controller('MainController', ["$scope","$q","$translate", "$cookies","CredentialService", "LocaleService", 
  "CurrencyService" , "ProductService", "CompanyService", "EmailService", "ngDialog",
  function ($scope, $q, $translate, $cookies, CredentialService, LocaleService, CurrencyService , 
    ProductService, CompanyService, EmailService, ngDialog) {
